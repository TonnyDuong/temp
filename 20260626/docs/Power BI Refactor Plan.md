...
3. **Filter** `Account No.` to `40010`, `40011`, `40012`, `40013`, `40014` only (the revenue codes).
...
6. **Add Column** → **Custom Column** to derive `Contract Type` from the account code:
   ```m
   if List.Contains({"40013", "40014"}, Text.From([#"Account No."])) then "Out of Contract" else "In Contract"
   ```
